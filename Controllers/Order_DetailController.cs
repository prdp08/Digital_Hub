...
using Digital_Hub.Data;
using Digital_Hub.Models;
using Microsoft.AspNetCore.Authorization;


namespace Digital_Hub.Controllers
{
    [Authorize]
    public class Order_DetailController : Controller
    {
        private readonly Digital_HubContext _context;

        public Order_DetailController(Digital_HubContext context)
        {
            _context = context;
        }
        ...
        {
            var Digital_HubContext = _context.Order_Detail.Include(o => o.Customer_Detail).Include(o => o.Product_Detail);
            return View(await Digital_HubContext.ToListAsync());
        }
