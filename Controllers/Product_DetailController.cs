...
namespace Digital_Hub.Controllers
{
    ...
    public class Product_DetailController : Controller
    {
        ...
        public Product_DetailController(Digital_HubContext context)
        {
            _context = context;
        }
        ...
        {
            var Digital_Hub = _context.Product_Detail.Include(p => p.Brand_Detail).Include(p => p.Category_Detail);
            return View(await Digital_Hub.ToListAsync());
        }
